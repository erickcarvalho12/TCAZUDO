...
export declare class Database implements DatabaseContract {
     ...
     */
    query(options?: DatabaseClientOptions): import("@ioc:Adonis/Lucid/DatabaseQueryBuilder").DatabaseQueryBuilderContract<any>;
    /**
     ...
     */
    insertQuery(options?: DatabaseClientOptions): import("@ioc:Adonis/Lucid/DatabaseQueryBuilder").InsertQueryBuilderContract<any[]>;
    /**
     * Returns a query builder instance for a given model.
     */
    modelQuery(model: any, options?: DatabaseClientOptions): import("@ioc:Adonis/Lucid/Model").ModelQueryBuilderContract<any, any>;
    /**
     * Returns an instance of raw query builder. Optionally one can
     * defined the `read/write` mode in which to execute the
     * query
     */
    rawQuery(sql: string, bindings?: any, options?: DatabaseClientOptions): import("@ioc:Adonis/Lucid/DatabaseQueryBuilder").RawQueryBuilderContract<any>;
    /**
     ...
     */
    from(table: any): import("@ioc:Adonis/Lucid/DatabaseQueryBuilder").DatabaseQueryBuilderContract<any>;
    /**
     * Returns insert query builder and selects the table
     */
    table(table: any): import("@ioc:Adonis/Lucid/DatabaseQueryBuilder").InsertQueryBuilderContract<any>;
    /**
